...
// AdminResetPasswordRequest is used by admins to reset a user's password
type AdminResetPasswordRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                  // Required: ID of user whose password to reset
	NewPassword   string                 `protobuf:"bytes,2,opt,name=new_password,json=newPassword,proto3" json:"new_password,omitempty"`   // Required: New password (min 8 characters)
	AdminUserId   string                 `protobuf:"bytes,3,opt,name=admin_user_id,json=adminUserId,proto3" json:"admin_user_id,omitempty"` // Required: ID of admin performing reset (for audit)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AdminResetPasswordRequest) GetAdminUserId() string {
	if x != nil {
...
const file_identity_proto_rawDesc = "" +
	...
	"\x17VERIFICATION_TYPE_EMAIL\x10\x022\xde\b\n" +
	...
	"\x0fGetUserCurrency\x12 .identity.GetUserCurrencyRequest\x1a!.identity.GetUserCurrencyResponse\x12Q\n" +
	"\x12AdminResetPassword\x12#.identity.AdminResetPasswordRequest\x1a\x16.google.protobuf.EmptyB3Z1github.com/Silicon-Savannah-Solutions/bethela-rpcb\x06proto3"
...
var file_identity_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_identity_proto_goTypes = []any{
	...
	(*AdminResetPasswordRequest)(nil),       // 22: identity.AdminResetPasswordRequest
	(*ListUsersRequest)(nil),                // 23: identity.ListUsersRequest
	(*ListUsersResponse)(nil),               // 24: identity.ListUsersResponse
	(*RequestVerificationCodeRequest)(nil),  // 25: identity.RequestVerificationCodeRequest
	(*RequestVerificationCodeResponse)(nil), // 26: identity.RequestVerificationCodeResponse
	(*VerifyAccountRequest)(nil),            // 27: identity.VerifyAccountRequest
	nil,                                     // 28: identity.UserMetadata.CustomAttributesEntry
...
var file_identity_proto_depIdxs = []int32{
	...
	29, // 3: identity.User.created_at:type_name -> google.protobuf.Timestamp
	29, // 4: identity.User.updated_at:type_name -> google.protobuf.Timestamp
	29, // 5: identity.User.last_login:type_name -> google.protobuf.Timestamp
	28, // 6: identity.UserMetadata.custom_attributes:type_name -> identity.UserMetadata.CustomAttributesEntry
