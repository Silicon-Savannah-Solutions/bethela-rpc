...
const (
	...
	IdentityService_AdminResetPassword_FullMethodName      = "/identity.IdentityService/AdminResetPassword"
)
...
type IdentityServiceClient interface {
	...
	// Admin resets a user's password directly (requires admin privileges)
	AdminResetPassword(ctx context.Context, in *AdminResetPasswordRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *identityServiceClient) AdminResetPassword(ctx context.Context, in *AdminResetPasswordRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, IdentityService_AdminResetPassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IdentityServiceServer interface {
	...
	// Admin resets a user's password directly (requires admin privileges)
	AdminResetPassword(context.Context, *AdminResetPasswordRequest) (*emptypb.Empty, error)
...
func (UnimplementedIdentityServiceServer) AdminResetPassword(context.Context, *AdminResetPasswordRequest) (*emptypb.Empty, error) {
...
func _IdentityService_AdminResetPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdminResetPasswordRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IdentityServiceServer).AdminResetPassword(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IdentityService_AdminResetPassword_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdentityServiceServer).AdminResetPassword(ctx, req.(*AdminResetPasswordRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var IdentityService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _IdentityService_AdminResetPassword_Handler,
		},
	},
