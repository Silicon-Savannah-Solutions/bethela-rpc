...
const (
	...
	CasinoService_UpdateGameCategory_FullMethodName    = "/casino.CasinoService/UpdateGameCategory"
	CasinoService_UpdateGame_FullMethodName            = "/casino.CasinoService/UpdateGame"
	CasinoService_SeedGames_FullMethodName             = "/casino.CasinoService/SeedGames"
	CasinoService_GetFinancialAnalytics_FullMethodName = "/casino.CasinoService/GetFinancialAnalytics"
...
type CasinoServiceClient interface {
	...
	UpdateGameCategory(ctx context.Context, in *UpdateGameCategoryRequest, opts ...grpc.CallOption) (*UpdateGameCategoryResponse, error)
	UpdateGame(ctx context.Context, in *UpdateGameRequest, opts ...grpc.CallOption) (*UpdateGameResponse, error)
	// Seed games from all registered providers
	SeedGames(ctx context.Context, in *SeedGamesRequest, opts ...grpc.CallOption) (*SeedGamesResponse, error)
	// Analytics methods for admin dashboard
	GetFinancialAnalytics(ctx context.Context, in *FinancialAnalyticsRequest, opts ...grpc.CallOption) (*FinancialAnalyticsResponse, error)
...
func (c *casinoServiceClient) UpdateGameCategory(ctx context.Context, in *UpdateGameCategoryRequest, opts ...grpc.CallOption) (*UpdateGameCategoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateGameCategoryResponse)
	err := c.cc.Invoke(ctx, CasinoService_UpdateGameCategory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *casinoServiceClient) UpdateGame(ctx context.Context, in *UpdateGameRequest, opts ...grpc.CallOption) (*UpdateGameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateGameResponse)
	err := c.cc.Invoke(ctx, CasinoService_UpdateGame_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *casinoServiceClient) SeedGames(ctx context.Context, in *SeedGamesRequest, opts ...grpc.CallOption) (*SeedGamesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SeedGamesResponse)
	err := c.cc.Invoke(ctx, CasinoService_SeedGames_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *casinoServiceClient) GetFinancialAnalytics(ctx context.Context, in *FinancialAnalyticsRequest, opts ...grpc.CallOption) (*FinancialAnalyticsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FinancialAnalyticsResponse)
	err := c.cc.Invoke(ctx, CasinoService_GetFinancialAnalytics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CasinoServiceServer interface {
	...
	UpdateGameCategory(context.Context, *UpdateGameCategoryRequest) (*UpdateGameCategoryResponse, error)
	UpdateGame(context.Context, *UpdateGameRequest) (*UpdateGameResponse, error)
	// Seed games from all registered providers
	SeedGames(context.Context, *SeedGamesRequest) (*SeedGamesResponse, error)
	// Analytics methods for admin dashboard
	GetFinancialAnalytics(context.Context, *FinancialAnalyticsRequest) (*FinancialAnalyticsResponse, error)
	// Internal methods used by the casino service
...
func (UnimplementedCasinoServiceServer) ListOriginalGames(context.Context, *ListGamesRequest) (*ListGamesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListOriginalGames not implemented")
}
...
func (UnimplementedCasinoServiceServer) GetPlayerHistory(context.Context, *GetPlayerHistoryRequest) (*GetPlayerHistoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPlayerHistory not implemented")
}
...
func (UnimplementedCasinoServiceServer) UpdateGameCategory(context.Context, *UpdateGameCategoryRequest) (*UpdateGameCategoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateGameCategory not implemented")
}
func (UnimplementedCasinoServiceServer) UpdateGame(context.Context, *UpdateGameRequest) (*UpdateGameResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateGame not implemented")
}
func (UnimplementedCasinoServiceServer) SeedGames(context.Context, *SeedGamesRequest) (*SeedGamesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SeedGames not implemented")
}
func (UnimplementedCasinoServiceServer) GetFinancialAnalytics(context.Context, *FinancialAnalyticsRequest) (*FinancialAnalyticsResponse, error) {
...
func (UnimplementedCasinoServiceServer) ProcessBet(context.Context, *ProcessBetRequest) (*ProcessBetResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ProcessBet not implemented")
}
func (UnimplementedCasinoServiceServer) ProcessWin(context.Context, *ProcessWinRequest) (*ProcessWinResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ProcessWin not implemented")
}
func (UnimplementedCasinoServiceServer) ProcessRollback(context.Context, *ProcessRollbackRequest) (*ProcessRollbackResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ProcessRollback not implemented")
}
...
func _CasinoService_UpdateGameCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateGameCategoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CasinoServiceServer).UpdateGameCategory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CasinoService_UpdateGameCategory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CasinoServiceServer).UpdateGameCategory(ctx, req.(*UpdateGameCategoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CasinoService_UpdateGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateGameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CasinoServiceServer).UpdateGame(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CasinoService_UpdateGame_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CasinoServiceServer).UpdateGame(ctx, req.(*UpdateGameRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CasinoService_SeedGames_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SeedGamesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CasinoServiceServer).SeedGames(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CasinoService_SeedGames_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CasinoServiceServer).SeedGames(ctx, req.(*SeedGamesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CasinoService_GetFinancialAnalytics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FinancialAnalyticsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CasinoServiceServer).GetFinancialAnalytics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CasinoService_GetFinancialAnalytics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CasinoServiceServer).GetFinancialAnalytics(ctx, req.(*FinancialAnalyticsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CasinoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CasinoService_UpdateGameCategory_Handler,
		},
		{
			MethodName: "UpdateGame",
			Handler:    _CasinoService_UpdateGame_Handler,
		},
		{
			MethodName: "SeedGames",
			Handler:    _CasinoService_SeedGames_Handler,
		},
		{
			MethodName: "GetFinancialAnalytics",
			Handler:    _CasinoService_GetFinancialAnalytics_Handler,
		},
		{
