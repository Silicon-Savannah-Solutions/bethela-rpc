...
const file_wallet_proto_rawDesc = "" +
	...
	"\aDeposit\x12\x16.wallet.DepositRequest\x1a\x17.wallet.DepositResponse\x129\n" +
	"\x06Reward\x12\x16.wallet.DepositRequest\x1a\x17.wallet.DepositResponse\x12=\n" +
...
var file_wallet_proto_depIdxs = []int32{
	...
	14, // 25: wallet.WalletService.Reward:input_type -> wallet.DepositRequest
	16, // 26: wallet.WalletService.Withdraw:input_type -> wallet.WithdrawRequest
	18, // 27: wallet.WalletService.TakeLien:input_type -> wallet.LienRequest
	20, // 28: wallet.WalletService.Revertlien:input_type -> wallet.RevertLienRequest
	22, // 29: wallet.WalletService.CommitLien:input_type -> wallet.CommitLienRequest
	24, // 30: wallet.WalletService.ManualReconciliation:input_type -> wallet.ManualReconciliationRequest
	10, // 31: wallet.WalletService.GetWalletByUserID:input_type -> wallet.GetWalletByUserIDRequest
	11, // 32: wallet.WalletService.CreateWallet:input_type -> wallet.CreateWalletRequest
	12, // 33: wallet.WalletService.GetWalletByID:input_type -> wallet.GetWalletByIDRequest
	13, // 34: wallet.WalletService.GetBalance:input_type -> wallet.GetBalanceRequest
	26, // 35: wallet.WalletService.ListTransactions:input_type -> wallet.ListTransactionsRequest
	8,  // 36: wallet.WalletService.C2B:output_type -> wallet.TransactionResponse
	8,  // 37: wallet.WalletService.B2C:output_type -> wallet.TransactionResponse
	8,  // 38: wallet.WalletService.TransactionInfo:output_type -> wallet.TransactionResponse
	15, // 39: wallet.WalletService.Deposit:output_type -> wallet.DepositResponse
	15, // 40: wallet.WalletService.Reward:output_type -> wallet.DepositResponse
	17, // 41: wallet.WalletService.Withdraw:output_type -> wallet.WithdrawResponse
	19, // 42: wallet.WalletService.TakeLien:output_type -> wallet.LienResponse
	21, // 43: wallet.WalletService.Revertlien:output_type -> wallet.RevertLienResponse
	8,  // 44: wallet.WalletService.CommitLien:output_type -> wallet.TransactionResponse
	25, // 45: wallet.WalletService.ManualReconciliation:output_type -> wallet.ManualReconciliationResponse
	4,  // 46: wallet.WalletService.GetWalletByUserID:output_type -> wallet.Wallet
	4,  // 47: wallet.WalletService.CreateWallet:output_type -> wallet.Wallet
	4,  // 48: wallet.WalletService.GetWalletByID:output_type -> wallet.Wallet
	3,  // 49: wallet.WalletService.GetBalance:output_type -> wallet.Balance
	28, // 50: wallet.WalletService.ListTransactions:output_type -> wallet.ListTransactionsResponse
